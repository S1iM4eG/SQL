...
--	IIF(CONDITION, value_1, value_2); Conditional Ternaty Operator: Усли условие (CONDITION) вернуло TRUE, то IIF возвращает значение 'value_1, в противном случае - 'value_2';
